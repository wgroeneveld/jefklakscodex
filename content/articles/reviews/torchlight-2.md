...
description: "Three years after the highly appreciated Torchlight release, Runic Games continues the trend with Torchlight 2, released only a few months after Diablo III. Should we be comparing this versus Diablo 2 or 3? Is it worth it to again hire a pet, gear up, and go after the Alchemist? Let's find out."
game_genre: 'Hack and Slash'
game_release_year: '2012'
game_developer: 'Runic Games'
---

In my original [Torchlight review](/articles/reviews/torchlight), I called Torchlight a _'near-perfect Diablo 2 clone - Diablo 2.5'_. Of course, I did not play its successor yet. Maybe I should start by saying that this is an even better version of the original game, but the additions make it more like a superior Diablo 3 than a Diablo 2. Both hack & slash games were released in 2012, so it is safe to assume that Runic did its homework and took out the magnifying glass to see how Diablo 3 works - or doesn't. As always, let's first dive into the world design. 
...
Maybe then I could give the engineer class a proper go... Until then, I'll keep on trudging on with my lvl `50+` Ember Mage in the New Game Plus, where monsters are scaled and item drops are increased. We'll see about that!
